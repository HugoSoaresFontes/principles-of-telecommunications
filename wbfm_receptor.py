...
# Title: wbfm_receptor
# Author: Hugo Soares
# Generated: Tue Jul  3 11:28:02 2018
##################################################
...
class wbfm_receptor(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "wbfm_receptor")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("wbfm_receptor")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "wbfm_receptor")
        ...
        self.connect((self.low_pass_filter_1_0, 0), (self.blocks_throttle_1, 0))    
...
def main(top_block_cls=wbfm_receptor, options=None):
